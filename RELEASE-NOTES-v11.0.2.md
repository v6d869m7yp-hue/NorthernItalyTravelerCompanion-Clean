# The Traveler’s Companion v11.0.2

Navigation consistency release.

- Renames the central Travel Dashboard to **Trip Hub**.
- Makes **Trip Hub** a first-class destination in the Companion primary navigation.
- Adds Trip Hub to Travel Mode shortcuts.
...
- Normalizes release/cache references to v11.0.2.
