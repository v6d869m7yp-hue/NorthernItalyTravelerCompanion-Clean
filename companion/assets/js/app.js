...
const APP_RELEASE={version:'8.2.0',buildId:'v8.2.0-unified-release-vault-session'};
...
function downloadDeviceSnapshot(){
  ...
  const snapshot={app:'Northern Italy Traveler’s Companion',version:APP_RELEASE.version,exportedAt:new Date().toISOString(),note:'Encrypted vault values remain encrypted. Keep this file private.',localStorage:values};
